			...
			<div class="row main-top-w3l py-2">
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<i class="fas fa-phone mr-2"></i> 0909999998
						</li>
						<li class="text-center border-right text-white">
						...
						<?php 
						if(isset($_SESSION['dangnhap_home'])){
							echo '<p class="text-white" data-toggle="modal" style="padding-left:770px ;color:#111; ">Xin chào bạn: '.$_SESSION['dangnhap_home'].'<a href="index.php?quanly=giohang&dangxuat=1">Đăng xuất</a></p>';
						}else{
							echo '';
						}
						?>
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.php" class="font-weight-bold font-italic">
							<img src="images/logo2.png" alt=" " class="img-fluid">Điện máy xanh
						</a>
					</h1>
				</div>
				<!-- //logo -->
